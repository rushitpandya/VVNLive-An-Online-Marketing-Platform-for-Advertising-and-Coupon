...
//		echo ("hi1");
		...
		//						move_uploaded_file($filename,$targetPath) ; // Moving Uploaded file						
								$query = mysqli_query($con,"INSERT INTO adsinformation(adname,adsid,adsimagepath,adstotalamount,fromdate,todate,adsurl,businessid,categoryid) VALUES('$adname','$adsid' ,'$targetPath1',$price,'$fromdate','$todate','$adurl','$businessid','$categoryid') ") or die(mysqli_error($con));
...
//			$adname1="abc";
			...
			$path1="simages/".$adname.$r1.$ext1;
			imagepng($IMG,$path);
			imagecolordeallocate($IMG, $line_color );
			imagecolordeallocate($IMG, $text_color );
			imagecolordeallocate($IMG, $background );
			imagedestroy($IMG);
			$query = mysqli_query($con,"INSERT INTO adsinformation(adname,adsid,adsimagepath,adstotalamount,fromdate,todate,adsurl,businessid,categoryid) VALUES('$adname','$adsid' ,'$path1',$price,'$fromdate','$todate','$adurl','$businessid','$categoryid') ") or die(mysqli_error($con));
			header('Location:advertisemain.php');			
			exit;
		}
