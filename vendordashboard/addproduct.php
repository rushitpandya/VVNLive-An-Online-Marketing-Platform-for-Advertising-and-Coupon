...
<?php
$sql1="SELECT categoryid FROM vendordetail WHERE vendorid='$vendorid'";
...
<div class="col s3" style="margin-left:19%" style="margin-right:50px"  >
          <div class="card purple darken-2 hoverable">
            <div class="card-content white-text center">
              <span class="center"><h3 style="border-left: 5px solid #ffffff ;font-family: GillSans, Calibri, Trebuchet, sans-serif; padding-left:0%;" class="white-text center">Add Product</h3></span>
			  <div class="row">
			  </br></br>
	<form class="col s12" method="POST" enctype="multipart/form-data" action="addproduct1.php">
      <div class="row">
        <div class="input-field col s12">
         ...
         <input  id="product_name" name="product_name" type="text" class="validate" onchange="capitalise()" required>
		...
		<div class="input-field col s6">
		 <i class="material-icons prefix prefix" style="margin-left:-260px;">loupe</i>
