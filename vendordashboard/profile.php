...
//		var category=$('#category').val();
		...
		{
        $.post("profileupdate.php", { username:username,firstname:firstname,lastname:lastname,vendoremail:vendoremail,vendorcno:vendorcno,vendoraddress:vendoraddress,pincode:pincode,date:date1},  
            function(result){  
                //if the result is 1  
                if(result == 1){  
...
//				alert(lastel);
	...
	<body>
				  ...
				  <?php $sql="SELECT * FROM vendordetail  WHERE username='$username' ";
	...
	<form class="col s12 " action="" method="post" enctype="multipart/form-data">
	  ...
	  <div class="row">
		<div class="input-field col s6 center ">
          ...
          <input id="vendoremail" type="email" value="<?php echo $row['vendoremail']; ?>" class="validate" required>
          <label for="vendoremail">Email</label>
        </div>
        <div class="input-field col s6">
			<i class="material-icons prefix orange-text text-darken-2" style="margin-right:30px;margin-top:15px">phone</i>
<!--          <input id="vendorcno" type="text" value="<?php echo $row['vendorcno']; ?>" style="margin-left:50px" >	-->
		  <input id="vendorcno" type="text" name="vendorcno" onkeypress="return isNumber(event)" onchange="ValidateNo();" value="<?php echo $row['vendorcno']; ?>" style="margin-left:50px" maxlength="10" required/>
	  ...
	  <div class="input-field col s6">
		<i class="material-icons prefix orange-text text-darken-2">message</i>
		  <textarea id="vendoraddress" class="materialize-textarea black-text" required><?php echo $row['vendoraddress']; ?></textarea>
	  ...
	  <div class="row center ">
		<div class="input-field col s6">
			...
			<input type="date" class="datepicker" id="date" value="<?php 
			$birthdate1=date('Y-m-d',strtotime($row['birthdate']));
			if($birthdate1=='1970-01-01')
			{
				echo "";
			}
			else
			{echo $birthdate1;} ?>" onchange="onbirthdatechange();" required>	
	  ...
	  <a class=" modal-action  btn-flat blue-grey darken-2 white-text text-darken-1"  href="profilephoto.php" style="margin-left:20px;">Upload Photo<i class="material-icons right center">picture_in_picture</i></a>
	  <a class=" modal-action  btn-flat blue-grey darken-2 white-text text-darken-1"  href="index.php" style="margin-left:20px;">View Profile<i class="material-icons right center">list</i></a></p>
