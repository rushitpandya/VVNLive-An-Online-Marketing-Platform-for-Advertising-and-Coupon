		...
		$(document).ready(function () {
			...
			var source =
			{
				...
				datafields: [
					...
					{ name: 'firstname'},
					{ name: 'lastname'},
					{ name: 'cno',type:'bigint'},
					{ name: 'email'},
					{ name: 'password'}
				],
				url: 'couponreportdata.php',
				sort: function()
				{
			...
			{		
				...
				columns: [
					...
					{ text: 'cno', datafield: 'cno', width: 100 },
					{ text: 'password', datafield: 'password', width: 200 }
				]
			});
            ...
            $("#excelExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xls', 'couponreport');           
            });
            $("#xmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xml', 'couponreport');
            });
            $("#csvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'csv', 'couponreport');
            });
            $("#tsvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'tsv', 'couponreport');
            });
            $("#htmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'html', 'couponreport');
            });
            $("#jsonExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'json', 'couponreport');
            });
            $("#pdfExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'couponreport');
            });
...
<body class='default' >
        ...
        <div class="row blue-text" style="font-size:30px;">Coupon Report</div>
		<div id="jqxgrid"></div>
