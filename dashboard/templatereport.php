		...
		$(document).ready(function () {
			...
			{		
				...
				columns: [
					...
					{ text: 'tempid', datafield: 'tempid', width: 80 },
					{ text: 'templatename', datafield: 'templatename', width: 220 },
					{ text: 'size', datafield: 'size', width: 80 },
					{ text: 'quantity', datafield: 'quantity', width: 150 },
					{ text: 'side', datafield: 'side', width: 80 },
					{ text: 'price', datafield: 'price', width: 100 },
					{ text: 'businessid', datafield: 'businessid', width: 100 },
					{ text: 'requestdate', datafield: 'requestdate', width: 270 }
				]
			});
            ...
            $("#excelExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xls', 'templatereport');           
            });
            $("#xmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xml', 'templatereport');
            });
            $("#csvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'csv', 'templatereport');
            });
            $("#tsvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'tsv', 'templatereport');
            });
            $("#htmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'html', 'templatereport');
            });
            $("#jsonExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'json', 'templatereport');
            });
            $("#pdfExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'templatereport');
            });
...
<body class='default' >
        ...
        <div class="row blue-text" style="font-size:30px;">Template Report</div>
		<div id="jqxgrid"></div>
