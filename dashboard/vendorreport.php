		...
		$(document).ready(function () {
			...
			{		
				...
				columns: [
					...
					{ text: 'vendoraddress', datafield: 'vendoraddress', width: 200 },
					{ text: 'gender', datafield: 'gender', width: 60 },
					{ text: 'birthdate', datafield: 'birthdate', width: 150 },
					{ text: 'pincode', datafield: 'pincode', width: 80 },
					{ text: 'businessname', datafield: 'businessname', width: 200 }
				]
			});
            ...
            $("#excelExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xls', 'vendorreport');           
            });
            $("#xmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'xml', 'vendorreport');
            });
            $("#csvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'csv', 'vendorreport');
            });
            $("#tsvExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'tsv', 'vendorreport');
            });
            $("#htmlExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'html', 'vendorreport');
            });
            $("#jsonExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'json', 'vendorreport');
            });
            $("#pdfExport").click(function () {
                $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'vendorreport');
            });
...
<body class='default' >
        ...
        <div class="row blue-text" style="font-size:30px;">Category Report</div>
		<div id="jqxgrid"></div>
